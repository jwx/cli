...
exports.ProjectTemplate = class {
  ...
  addToCopyFiles(files) {
    this.model.build.copyFiles = Object.assign({}, this.model.build.copyFiles, files);
    return this;
  }

  addNPMScript(name, script) {
    if (this.createNPMScripts) {
      this.package.scripts[name] = script;
    }
